...
class SCTA_Activate_Subscription extends Trigger {

	public static function get_id() {
		return 'studiocart/activate-subscription';
	}

	public static function get_wp_hook() {
		return 'sc_subscription_active';
	}

	public static function get_provided_data_objects() {
		return [ 
			User_Data::get_id(),
			SCTA_Subscription_Data::get_id()
		];
	}
	...
	public static function get_description() {
		return 'When a subscription is activated';
	}
